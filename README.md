# tf-atom-launch-template-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-launch-template-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-launch-template-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS Launch Template - defines EC2 instance configuration for ASG use.
...
| <a name="input_image_id"></a> [image\_id](#input\_image\_id) | AMI ID | `string` | `null` | no |
...
| <a name="input_network_interface"></a> [network\_interface](#input\_network\_interface) | Network interface configuration | <pre>object({<br/>    associate_public_ip_address = optional(bool, false)<br/>    security_groups             = optional(list(string), [])<br/>  })</pre> | `null` | no |
...
| <a name="input_user_data_base64"></a> [user\_data\_base64](#input\_user\_data\_base64) | Base64-encoded user data | `string` | `null` | no |

### Outputs

| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the launch template |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether the module is enabled |
| <a name="output_id"></a> [id](#output\_id) | ID of the launch template |
| <a name="output_latest_version"></a> [latest\_version](#output\_latest\_version) | Latest version number |
<!-- END_TF_DOCS -->
